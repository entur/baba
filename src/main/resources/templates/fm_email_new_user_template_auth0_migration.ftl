...
<p>
    ...
    <i>Your account with Entur in the production environment (PROD) will soon be migrated to a new authentication system.</i><br>
    <br>
    <p>
    Torsdag 13/11/2025 vil autentiseringsløsningen aktiveres: Før du logger inn på våre tjenester første gang, må passordet endres ved å velge "Glemt passord".<br>
    <i>Thursday 13/11/2025, the new system will be activated. Before logging into our services for the first time, you will need to reset your password by selecting "Forgot password."</i><br>
    <p>
