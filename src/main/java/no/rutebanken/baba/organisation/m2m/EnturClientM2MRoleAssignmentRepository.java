...
public class EnturClientM2MRoleAssignmentRepository {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(EnturClientM2MRoleAssignmentRepository.class);
    ...
    public List<RoleAssignment> getRolesAssignments(AuthenticatedUser authenticatedUser) {
        ...
        List<RoleAssignment> rolesFromDatabase = getRoleAssignmentsFromDatabase(authenticatedUser, repository);
        LOGGER.info("Returning {} role assignments from database for client {} and organisation {}",
                rolesFromDatabase.size(), authenticatedUser.subject(), authenticatedUser.organisationId());
    ...
    private static List<RoleAssignment> getRoleAssignmentsFromDatabase(AuthenticatedUser authenticatedUser, M2MClientRepository repository) {
